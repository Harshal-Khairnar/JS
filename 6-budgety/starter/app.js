...
var budgetController = (function () {
    ...
    return {
        ...
        addItem: function (type, des, val) {
            ...
            // create new item object based on type i.e 'exp' or 'inc'
            if (type === 'inc') {
...
var UIController = (function () {
    ...
    return {
        ...
        displayDate: function () {
            ...
            now = new Date();
            months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'Auguest', 'Sepentember', 'October', 'November', 'December'];
            month = now.getMonth();
